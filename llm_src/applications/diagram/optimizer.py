...
from llm_src.domains.geometry.instructions import Parameter, Assertion
from llm_src.domains.geometry.value_objects import Point, Line
from llm_src.domains.geometry.entities import GeometricPoint, Diagram
from llm_src.domains.geometry.types import QuadrilateralType, TriangleType, DiagramType
from llm_src.applications.diagram.initializer import Initializer
...
class Optimizer:
    ...
    def process_instruction(self, instr):
        from llm_src.domains.geometry.instructions import Assertion

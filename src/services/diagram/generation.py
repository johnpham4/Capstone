...
class DiagramService:
    ...
    def generate_dsl(
        ...
        if llm_mock:
            logger.info("LLM mock mode — returning canned DSL")
            return MOCK_DSL
        ...
        if "choices" in result and result["choices"]:
            ...
            dsl_text = choice.get("message", {}).get("content", "") or choice.get("text", "")
        else:
            dsl_text = result.get("generated_text", result.get("text", ""))

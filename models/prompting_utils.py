...
class UniversalPrompting():
    def __init__(self, text_tokenizer,
        ...
        # Handle Qwen tokenizer that doesn't have bos_token by default
        bos_id = self.text_tokenizer.bos_token_id if self.text_tokenizer.bos_token_id is not None else self.text_tokenizer.eos_token_id

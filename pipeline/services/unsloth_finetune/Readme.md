<<<<<<<< HEAD:src/services/model/Readme.md
...
File: `llm_src/core/aws/create_sagemaker_role.py`
...
File: `llm_src/core/aws/create_sagemaker_execution_role.py`
...
File: `llm_src/model/deploy/huggingface/run.py`
...
- Configures the endpoint based on settings in `llm_src.settings`
...
- Configure your settings in `llm_src.settings`, including:
  - `GPU_INSTANCE_TYPE`
...
## Note
Ensure you have the necessary permissions in your AWS account to create IAM users and roles, deploy SageMaker endpoints, and perform inference before running these scripts.
>>>>>>>> minh-re:pipeline/services/unsloth_finetune/Readme.md

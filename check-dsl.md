...
### Tieu chuan short_reason (BAT BUOC CHI TIET)
- Khong duoc viet kieu chung chung: "DSL co loi", "sai theo rule", "can review".
- Moi short_reason phai neu RO IT NHAT 3 thanh phan:
1) Rang buoc trong de bi vi pham (trich ngan gon phan lien quan).
2) DSL/anh hien tai dang the hien gi (thuc te quan sat duoc).
3) Ket luan sai lech cu the (sai goc nao, thieu segment nao, sai diem nao, sai tam nao...) va huong sua toi thieu.
- Neu co nhieu loi, liet ke theo thu tu uu tien: DSL truoc, IMAGE sau.
- Neu la FAIL do DSL_ANGLE: bat buoc ghi ro goc nao trong de, dong DSL nao dang sai, sai gia tri hay sai thu tu dinh.
- Neu la FAIL do DSL_MISSING_CONSTRAINT: bat buoc ghi ro rang buoc thieu va cau DSL can co (vi du: "thieu (segment D E)").
- Neu la FAIL do IMAGE_GEOMETRY_MISMATCH: bat buoc ghi ro phan hinh lech (vi du: "de noi BC // DE nhung anh ve DE cat BC").
- Neu la REVIEW: bat buoc ghi ro cau nao trong de mo ho va vi sao khong the xac dinh hinh duy nhat.
- Neu la IMAGE_MISSING: bat buoc ghi da thu day du fallback nao.

Mau short_reason nen dung:
- FAIL (goc): "De yeu cau goc ACB = 30, nhung DSL dang co (angle-measure A B C 30) (dinh B) -> sai mapping goc. Can sua thanh (angle-measure A C B 30)."
- FAIL (thieu rang buoc): "De neu BC // DE nhung DSL chi co (segment B C), khong co (segment D E)/(parallel ...). Can them (segment D E) va (parallel (segment B C) (segment D E))."
- FAIL (anh sai): "DSL da co BC // DE nhung anh the hien DE cat BC tai mot diem -> IMAGE_GEOMETRY_MISMATCH."
- REVIEW: "Cum 'duong thang la duong trung truc cua AB' khong noi duong do di qua diem nao, nen co vo so cau hinh hop le -> can REVIEW."
- IMAGE_MISSING: "Khong tim thay anh sau khi thu diagram_<id>.png/jpg/jpeg/webp va img_<id>.png/jpg/jpeg/webp trong IMAGE_ROOT."
- PASS: "DSL khop day du rang buoc (....), anh cung the hien dung quan he chinh (....)."
...
- short_reason phai la mo ta theo TUNG BAI, co noi dung ky thuat co the kiem chung duoc (khong copy template chung cho nhieu item).
- Neu status=FAIL thi short_reason phai de cap it nhat 1 reason_code tuong ung bang bang chung cu the.
